...
public:
    ...
    QLabel *utilLabel;
    QLineEdit *utilLineEdit;
    QPushButton *set_util;
    ...
    void setupUi(QDialog *fp)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(70, 440, 91, 31));
        ...
        formLayoutWidget_2->setGeometry(QRect(10, 160, 183, 143));
        ...
        enter_button->setGeometry(QRect(20, 310, 89, 25));
        ...
        browse_button->setGeometry(QRect(150, 310, 89, 25));
        FPGA = new QPushButton(fp);
        FPGA->setObjectName(QStringLiteral("FPGA"));
        FPGA->setGeometry(QRect(200, 10, 71, 25));
        formLayoutWidget_4 = new QWidget(fp);
        formLayoutWidget_4->setObjectName(QStringLiteral("formLayoutWidget_4"));
        formLayoutWidget_4->setGeometry(QRect(10, 390, 181, 41));
        formLayout_4 = new QFormLayout(formLayoutWidget_4);
        formLayout_4->setSpacing(6);
        formLayout_4->setContentsMargins(11, 11, 11, 11);
        formLayout_4->setObjectName(QStringLiteral("formLayout_4"));
        formLayout_4->setContentsMargins(0, 0, 0, 0);
        utilLabel = new QLabel(formLayoutWidget_4);
        utilLabel->setObjectName(QStringLiteral("utilLabel"));

        formLayout_4->setWidget(1, QFormLayout::LabelRole, utilLabel);

        utilLineEdit = new QLineEdit(formLayoutWidget_4);
        utilLineEdit->setObjectName(QStringLiteral("utilLineEdit"));

        formLayout_4->setWidget(1, QFormLayout::FieldRole, utilLineEdit);

        set_util = new QPushButton(fp);
        set_util->setObjectName(QStringLiteral("set_util"));
        set_util->setGeometry(QRect(200, 380, 81, 25));
    ...
    void retranslateUi(QDialog *fp)
    {
        ...
        utilLabel->setText(QApplication::translate("fp", "Util", nullptr));
        set_util->setText(QApplication::translate("fp", "Set", nullptr));
    } // retranslateUi
